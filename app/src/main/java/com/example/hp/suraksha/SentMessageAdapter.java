...
public class SentMessageAdapter extends RecyclerView.Adapter<SentMessageAdapter.DataHolder> {
    ...
    public DataHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(mContext).inflate(R.layout.lay_view_in_recyclerview,null);
    ...
    public void onBindViewHolder(DataHolder holder, int position) {
        ...
        holder.mTimeText.setText(mArrayList.get(position).getTime());
    }
    ...
    public class DataHolder extends RecyclerView.ViewHolder {
        TextView mProblemText,mTimeText;
        public DataHolder(View itemView) {
            super(itemView);
            mProblemText= (TextView) itemView.findViewById(R.id.problemText);;
